...
namespace Micro_social_platform.Controllers
{
    ...
    public class ProfilesController : Controller
    {
        ...
        public IActionResult Show(string id)
        {
            ...
            var are_friends = db.Friends.Where(friend => friend.User_sender_id == id && friend.User_receiver_id == _userManager.GetUserId(User) || friend.User_receiver_id == id && friend.User_sender_id == _userManager.GetUserId(User) && friend.Has_accepted == true);
